...
/**
 * For each character, look it up in the dictionary to see if there are other instances, if not, put
 * it in the dictionary. This implementation looks to do the above in O(n) time
 */
