...
public class BSTImplementation {
  ...
  /**
   * Java function to check if binary tree is empty or not Time Complexity of this solution is
   * constant O(1) for best, average and worst case.
   *
  ...
  /**
   * Java function to return number of nodes in this binary search tree. Time complexity of this
   * method is O(n)
   *
